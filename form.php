...
<!--CONTENT-------------------------------------------------------------------------------------->
<a href="index.html"><button class="submit backToHome" style="top: 0px;">BACK TO MAIN PAGE</button></a>
...
<div style="position:absolute;left:50%;margin-left:-306px;top:0px;width:612px;height:792px;border-style:outset;overflow:hidden">
    ...
    <div style="position:absolute;left:36.00px;top:36.00px" class="cls_002">
        <span class="cls_002">DOUG CHUNG, DDS</span>
    </div>
    <div style="position:absolute;left:324.00px;top:36.00px" class="cls_003">
        <span class="cls_003"><a HREF="">chungoffice@gmail.com</a></span>
    </div>
    <div style="position:absolute;left:504.00px;top:36.00px" class="cls_002">
        <span class="cls_002">PAGE 1</span>
    </div>
    <div style="position:absolute;left:36.00px;top:58.00px" class="cls_005">
        <span class="cls_005">DENTAL ANESTHESIOLOGY  PO BOX 1058 DRAPER, UT 84020  (801) 571-5665   FAX (801)572-9491</span>
    </div>
    <div style="position:absolute;left:36.00px;top:103.00px" class="cls_005">
    ...
    <div style="position:absolute;left:36.00px;top:178.00px" class="cls_005">
        <span class="cls_005">
            Patient<input type="text" name="patient1" style="width: 300px;" required placeholder="Full name">
            Birthdate <input type="date" name="birthdate" style="width: 125px;">
        </span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:223.00px" class="cls_005">
        <span class="cls_005">
            Name<input type="text" name="name" style="width: 293px;" placeholder="Yourself or Person Responsible">
            Social Security # <input type="text" placeholder="000-00-0000" name="social" style="width: 101px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:240.00px" class="cls_005"><span class="cls_005">
        Street Address<input type="text" name="address" style="width: 447px;" placeholder="123 Apple St."></span>
    </div>
    <div style="position:absolute;left:36.00px;top:257.00px" class="cls_005">
        <span class="cls_005">
            City<input type="text" name="city" style="width: 214px;" placeholder="Apple City">
            State<input type="text" name="state" style="width: 40px;" placeholder="UT">
            Zip<input type="text" name="zip" style="width: 50px;" placeholder="00000">
            Phone#<input type="text" name="phone" placeholder="801-555-5555" style="width: 97px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:273.00px" class="cls_005">
        <span class="cls_005">
            Birthdate<input type="date" name="birthdate2" style="width: 125px;">
            Employer<input type="text" name="employer" style="width: 120px;">
            Bus Phone#<input type="text" name="busPhone" placeholder="801-555-5555" style="width: 100px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:291.00px" class="cls_005">
        <span class="cls_005">If guardian, relationship to patient<input type="text" name="relationToPatient" style="width: 150px;"</span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:326.00px" class="cls_005">
        <span class="cls_005">
            Name<input type="text" name="emergencyName" style="width: 300px;" placeholder="Full name">
            Phone#<input type="text" name="emergencyPhone" style="width: 150px;" placeholder="801-555-5555">
        </span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:676.00px" class="cls_005">
        <span class="cls_005">
            Signature<input type="text" name="signature" style="width: 315px;" placeholder="Type full name">
            Date<input type="text" name="signDate" style="width: 125px;" value="<?php echo date("m/d/Y")?>">
        </span>
    </div>
...
<div style="position:absolute;left:50%;margin-left:-306px;top:802px;width:612px;height:792px;border-style:outset;overflow:hidden">
    ...
    <div style="position:absolute;left:36.00px;top:67.00px" class="cls_012">
        <span class="cls_012">
            Patient’s name<input type="text" name="patient2" style="width: 250px;" placeholder="Full name">
        </span>
    </div>
    <div style="position:absolute;left:362.40px;top:62.00px" class="cls_012">
        <span class="cls_012">
            ...
            Weight<input type="text" name="weight" style="width: 35px;" placeholder="180">
            Height<input type="text" name="height" style="width: 35px;" pattern="[1-9 ]{1,4}" placeholder="5 6">
        </span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:108.00px" class="cls_010">
        <span class="cls_010">
            <input type="radio" name="yn1" value="yes1">YES
            <input type="radio" name="yn1" value="no1"> NO
            Are you under the care of a physician? If yes, who:<input type="text" name="ynQ1" style="width: 250px; height: 12px; font-size: 8px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:122.00px" class="cls_010">
        <span class="cls_010">
            <input type="radio" name="yn2" value="yes2">YES
            <input type="radio" name="yn2" value="no2"> NO
            Currently taking any medications? If yes LIST:<input type="text" name="ynQ2" style="width: 262px; height: 12px; font-size: 8px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:136.00px" class="cls_010">
        <span class="cls_010">
            <input type="radio" name="yn3" value="yes3">YES
            <input type="radio" name="yn3" value="no3"> NO
            Any drug allergies/sensitivities? If yes LIST:<input type="text" name="ynQ3" style="width: 274px; height: 12px; font-size: 8px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:150.00px" class="cls_010">
        <span class="cls_010">
            <input type="radio" name="yn4" value="yes4">YES
            <input type="radio" name="yn4" value="no4"> NO
            Hospitalized in past 5 years? If yes LIST:<input type="text" name="ynQ4" style="width: 288px; height: 12px; font-size: 8px;">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:165.00px" class="cls_010">
        <span class="cls_010">
            <input type="radio" name="yn5" value="yes5">YES
            <input type="radio" name="yn5" value="no5"> NO
            Have you ever had anesthesia for surgery? If yes LIST:<input type="text" name="ynQ5" style="width: 231px; height: 12px; font-size: 8px;">
        </span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:209.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="heartProblem" value="yes">Heart Problems|</span>
    </div>
    <div style="position:absolute;left:128.73px;top:209.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="stroke" value="yes">Stroke|</span>
    </div>
    <div style="position:absolute;left:185.54px;top:209.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="asthma" value="yes">Asthma|</span>
    </div>
    <div style="position:absolute;left:252.00px;top:209.00px" class="cls_012">
        <span class="cls_012">
            <input type="checkbox" name="diabetes" value="yes">Diabetes Type I or II|
            <input type="checkbox" name="psychiatric" value="yes">Psychiatric Treatment|
            <input type="checkbox" name="bleeding" value="yes">Excessive Bleeding
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:221.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="kidney" value="yes">Kidney Disease|</span>
    </div>
    <div style="position:absolute;left:127.91px;top:221.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="anemia" value="yes">Anemia|</span>
    </div>
    <div style="position:absolute;left:185.54px;top:221.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="aids" value="yes">AIDS|</span>
    </div>
    <div style="position:absolute;left:252.00px;top:221.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="emphysema" value="yes">Emphysema|</span>
    </div>
    <div style="position:absolute;left:360.00px;top:221.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="bloodPressure" value="yes">High Blood Pressure|</span>
    </div>
    <div style="position:absolute;left:479.54px;top:221.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="rheumatic" value="yes">Rheumatic Fever</span>
    </div>
    <div style="position:absolute;left:36.00px;top:233.00px" class="cls_012">
        <span class="cls_012">
            <input type="checkbox" name="venereal" value="yes">Venereal Disease|
            <input type="checkbox" name="cancer" value="yes">Cancer|
        </span>
    </div>
    <div style="position:absolute;left:194.54px;top:233.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="ulcers" value="yes">Ulcers|</span>
    </div>
    <div style="position:absolute;left:252.00px;top:233.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="hepatitis" value="yes">Hepatitis A B C ?|</span>
    </div>
    <div style="position:absolute;left:360.00px;top:233.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="addiction" value="yes">Drug Addiction|</span>
    </div>
    <div style="position:absolute;left:473.54px;top:233.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="murmur" value="yes">Heart Murmur</span>
    </div>
    <div style="position:absolute;left:36.00px;top:245.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="liverDisease" value="yes">Liver Disease|</span>
    </div>
    <div style="position:absolute;left:127.38px;top:245.00px" class="cls_012">
        <span class="cls_012">
            <input type="checkbox" name="glaucoma" value="yes">Glaucoma|
            <input type="checkbox" name="smoker" value="yes">Smoker|
        </span>
    </div>
    <div style="position:absolute;left:252.00px;top:245.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="tuberculosis" value="yes">Tuberculosis|</span>
    </div>
    <div style="position:absolute;left:353.00px;top:245.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="fainting" value="yes">Fainting or Dizziness|</span>
    </div>
    <div style="position:absolute;left:473.54px;top:245.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="epilepsy" value="yes">Epilepsy/Seizures</span>
    </div>
    <div style="position:absolute;left:36.00px;top:257.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="thyroid" value="yes">Thyroid Disease|</span>
    </div>
    <div style="position:absolute;left:130.47px;top:257.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="arthritis" value="yes">Arthritis|</span>
    </div>
    <div style="position:absolute;left:193.54px;top:257.00px" class="cls_012">
        <span class="cls_012">
            <input type="checkbox" name="chestPain" value="yes">Chest Pains|
            <input type="checkbox" name="fenPhen" value="yes">Fen-PHen Diet|
        </span>
    </div>
    <div style="position:absolute;left:368.00px;top:257.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="echocardiogram" value="yes">Echocardiogram|</span>
    </div>
    <div style="position:absolute;left:473.54px;top:257.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="hiv" value="yes">HIV Positive</span>
    </div>
    <div style="position:absolute;left:36.00px;top:269.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="fibromyalgia" value="yes">Fibromyalgia|</span>
    </div>
    <div style="position:absolute;left:127.38px;top:269.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="anxiety" value="yes">Anxiety|</span>
    </div>
    <div style="position:absolute;left:200.54px;top:269.00px" class="cls_012">
        <span class="cls_012">
            <input type="checkbox" name="depression" value="yes">Depression|
            <input type="checkbox" name="bipolar" value="yes">Bipolar|
        </span>
    </div>
    <div style="position:absolute;left:340.00px;top:269.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="aad" value="yes">ADD or ADHD|</span>
    </div>
    <div style="position:absolute;left:433.54px;top:269.00px" class="cls_012">
        <span class="cls_012"><input type="checkbox" name="autism" value="yes">Autism</span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:283.00px" class="cls_010">
        <span class="cls_010">
            <input type="radio" name="yn6" value="yes6">YES
            <input type="radio" name="yn6" value="no6"> NO
            Any mental or physical disabilities? If yes LIST:<input type="text" name="ynQ6" style="width: 257px; height: 12px; font-size: 8px;"></span></div>
    <div style="position:absolute;left:36.00px;top:298.00px" class="cls_010">
        <span class="cls_010">
            Do you Snore?
            <input type="radio" name="yn7" value="yes7">YES
            <input type="radio" name="yn7" value="no7"> NO
            Do you have Sleep Apnea ?
            <input type="radio" name="yn8" value="yes8">YES
            <input type="radio" name="yn8" value="no8"> NO
        </span>
    </div>
    <div style="position:absolute;left:370.00px;top:298.00px" class="cls_010">
        <span class="cls_010">
            Do you use a CPAP/BiPAP machine?
            <input type="radio" name="yn9" value="yes9">YES
            <input type="radio" name="yn9" value="no9"> NO
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:312.00px" class="cls_010">
        <span class="cls_010">
            Do you wear contacts?
            <input type="radio" name="yn10" value="yes10">YES
            <input type="radio" name="yn10" value="no10"> NO
            If yes - Do you take naps or sleep with them in?
            <input type="radio" name="yn11" value="yes11">YES
            <input type="radio" name="yn11" value="no11"> NO
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:324.00px" class="cls_010">
        <span class="cls_010">
            Are you very anxious/nervous about dental treatment?
            <input type="radio" name="yn12" value="yes12">YES
            <input type="radio" name="yn12" value="no12"> NO
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:338.00px" class="cls_010">
        <span class="cls_010">
            WOMEN: Are you pregnant?
            <input type="radio" name="preg" value="yesPreg">YES
            <input type="radio" name="preg" value="noPreg"> NO
        </span>
    </div>
    <div style="position:absolute;left:236.78px;top:338.00px" class="cls_010">
        <span class="cls_010">
            Are you nursing?
            <input type="radio" name="nursing" value="yesNursing">YES
            <input type="radio" name="nursing" value="noNursing"> NO
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:362.00px" class="cls_012">
        <span class="cls_012">
            SIGNATURE<input type="text" name="signature2" style="width: 275px;">
            Date<input type="text" name="dateSign2" style="width: 150px;" value="<?php echo date("m/d/Y")?>">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:390.00px" class="cls_012">
        ...
        Date<input type="text" name="dateSign3" style="width: 150px;" readonly value="<?php echo date("m/d/Y")?>">
        </span>
    </div>
    ...
    <div style="position:absolute;left:36.00px;top:700.00px" class="cls_012">
        <span class="cls_012">
            SIGNATURE<input type="text" name="signature4" style="width: 275px;">
            Date<input type="text" name="dateSign4" style="width: 150px;" value="<?php echo date("m/d/Y")?>">
        </span>
    </div>
    <div style="position:absolute;left:36.00px;top:730.00px" class="cls_012">
        ...
        Date<input type="text" name="dateSign5" style="width: 150px;" readonly value="<?php echo date("m/d/Y")?>">
        </span>
    </div>
...
<!-- SUMBIT BUTTON --------------------------------------------------------------------->
    ...
    <div style="position:absolute;left:150.80px;top:760.00px">
        <button class="submit hidePrint" style="margin: 5px 10px;">CANCEL</button>
        <button onClick="window.print()"  class="submit hidePrint">PRINT FORM</button>
        <input type="submit" name="submit" class="submit hidePrint" style="margin: 5px 10px;" value="SUBMIT FORM">
    </div>
